...
class TableConfigEnum(Enum):
    ...
    #     "financial_report",
    #     re_pattern.second_title_scope_change_pattern,
    #     re_pattern.diff_ctl_org_mg_cur_prd_start_pattern,
    #     re_pattern.diff_ctl_org_mg_cur_prd_parent_start_pattern,
    #     re_pattern.diff_ctl_org_mg_cur_prd_end_pattern, prompt_constants.prompt11)
    ...
    #     re_pattern.diff_ctl_org_mg_cost_gw_end_pattern, prompt_constants.prompt11)
    # OTHER_RELATED_PARTY = (
    #     "其他关联方", "1",
    #     "financial_report",
    #     re_pattern.second_title_related_party_pattern,
    #     re_pattern.other_related_party_start_pattern,
    #     re_pattern.other_related_party_parent_start_pattern,
    #     re_pattern.other_related_party_end_pattern, prompt_constants.prompt11)
