...
second_title_financial_report_all_pattern = re.compile(
    r'^\(?(一|二|三|四|五|六|七|八|九|十|十一|十二|十三|十四|十五|十六|十七)、?\)?\s*(公司基本的?情况|财务报表的编制基础|重要会计政策及会计估计|运用会计政策过程中所作的重要判断和会计估计所采用的关键假设和不确定因素|会计政策变更|税项|会计政策和会计估计变更以及前期差错更正的说明|合并财务报表范围|(合并)?财务报表(主要)?项目(注释|附注)|研发支出|合并范围的?(变更|变动|变化)|在?其他主体中的?权益的?(披露)?|政府补助|金融工具及其?风险(管理)?|与金融工具相关的风险|金融工具的分类及其公允价值|公允价值的披露|分部报告|关联方及关联方?交易|关联方关系及其交易|或有事项|承诺事项|承诺及或有事项|期后事项|母公司(主要)?财务报表(主要)?(项目)?的?注释|资本管理|股份支付(：无)?|其他重要事项|非经常性损益明细表|净资产收益率及每股亏损|资产负债表日后事项)$')
# 合并财务报表项目注释
