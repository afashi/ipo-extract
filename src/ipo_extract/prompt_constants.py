...
- 文本分析 ：
  ...
  - 能够准确分析《短期借款》的章节下，如没有表格则需要判断是否标注不适用，未披露情况下一般会标注不适用。披露情况下一般会不标注或标注适用。
  - 能够分析出自己是否能对这次任务做出准确判断，如数据披露过少，表头部分确实等无法做出准确判断则该认为需要人工介入
...
- 文本分析 ：
  ...
  - 能够准确分析《长期借款》的章节下，如没有表格则需要判断是否标注不适用，未披露情况下一般会标注不适用。披露情况下一般会不标注或标注适用。
  - 能够分析出自己是否能对这次任务做出准确判断，如数据披露过少，表头部分确实等无法做出准确判断则该认为需要人工介入
...
- 文本分析 ：
  ...
  - 能够准确分析《应付利息》的章节下，如没有表格则需要判断是否标注不适用，未披露情况下一般会标注不适用。披露情况下一般会不标注或标注适用。
  - 能够分析出自己是否能对这次任务做出准确判断，如数据披露过少，表头部分确实等无法做出准确判断则该认为需要人工介入
